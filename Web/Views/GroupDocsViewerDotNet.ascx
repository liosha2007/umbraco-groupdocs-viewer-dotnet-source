...
<div id="groupdocs-viewer-dotnet" style="width: 1000px; height: 500px; overflow: auto; position: relative;margin-bottom: 20px;background-color: gray"></div>

    <script type="text/javascript">
        $(function () {
            var localizedStrings = null;
            var thumbsImageBase64Encoded = null;
            $('#groupdocs-viewer-dotnet').groupdocsViewer({
